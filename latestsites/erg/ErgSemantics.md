...
others](). ERS can be expressed in various ways,
...
Treebank](); Oepen, et al., 2004; Flickinger, et al., 2012)
or by processing new text with the ERG and its
...
ErgSemantics/Essence page provides a high-level
...
ErgSemantics/Basics page. Beyond these more
technical foundations, the ErgSemantics/Design
...
ErgSemantics/Inventory page, and the process
we followed for selecting phenomena to document is described on the
ErgSemantics/Discovery page. We recommend
starting the exploration of these resources via the following links:

- High-Level Characterization
- Semi-Formal and Terminological Basics
- High-Level Linguistic Design Decisions
- Inventory of Individual Phenomena
...
extension of the MRS Test Suite.
