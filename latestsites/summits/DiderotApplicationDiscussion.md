{% raw %}[JanBuys](../JanBuys): Current deep learning replaces everything with a
...
[EmilyBender](../EmilyBender): If we don't get improvements, it's because
the tasks are tailored to this end-to-end paradigm. What are interesting
tasks?

[JanBuys](../JanBuys): Recently, there's more interest in designing
specific test sets, to show generalisation from the training data.

[EmilyBender](../EmilyBender): We also need to generalise \*across tasks\*
– we can't just do 1500 end-to-end tasks and expect a general system.

[JanBuys](../JanBuys): There's recent work trying to show, if you have a
good language model, that knowledge is applicable to multiple tasks.
It's still not quite the same as what you're asking.

[EmilyBender](../EmilyBender): Not meaning-sensitive.

[JohnCarroll](../JohnCarroll): What's an interpretable model? If there's
any deep learning, that part is not interpretable.

[JanBuys](../JanBuys): Interpretability is hard to define. You can have a
...
[JohnCarroll](../JohnCarroll): Unless the deep model is ignoring all that
...
[JanBuys](../JanBuys): "Explainable" might be a better word – potentially,
...
[BertholdCrysmann](../BertholdCrysmann): Do you remember the demo with the
boxes flashing up?

[AlexanderKoller](../AlexanderKoller): I remember in my [HiWi](/HiWi) days,
where we had type hierarchies that filled the whole wall.

[GuyEmerson](../GuyEmerson): One answer is to design systems that are
...
[JanBuys](../JanBuys): Another answer is to use more probabilistic models,
...
[EmilyBender](../EmilyBender): Maybe we should think about the ways in
...
[JanBuys](../JanBuys): On one extreme, you would have a model which you
...
[DanFlickinger](../DanFlickinger): Relatively modest by today's standard. I
can't remember exactly.

[EmilyBender](../EmilyBender): It was also crowdsourced and messy.
...
[EmilyBender](../EmilyBender): Multilingual tasks? Could be seen as
transfer learning, because MRS has information beyond the surface
string.

[JanBuys](../JanBuys): That area hasn't been worked on enough.

[EmilyBender](../EmilyBender): We don't have any grammars as large as the
ERG, but there are a couple of language pars where we could do
something.

[EmilyBender](../EmilyBender): There are a few people here working on
...
[GuyEmerson](../GuyEmerson): I've had quite a mix of reactions. Some people
...
[JanBuys](../JanBuys): One potential way is to focus on datasets. If you
...
[EmilyBender](../EmilyBender): We need a task that isn't easily modelled
end-to-end.
...
[EmilyBender](../EmilyBender): What kinds of reactions do you get from deep
learning people?
...
[EmilyBender](../EmilyBender): That's one answer to, "how do we get people
to care?" – get the magic number!

[OlgaZamaraeva](../OlgaZamaraeva): The numbers question is a good one, but
...
[JohnCarroll](../JohnCarroll): Other communities, like the CCG community,
...
[EmilyBender](../EmilyBender): From the COLING perspective, I don't think
...
[OlgaZamaraeva](../OlgaZamaraeva): Dirk Hovy has a graph of the change,
...
[OlgaZamaraeva](../OlgaZamaraeva): Accepted.

[FrancisBond](../FrancisBond): It might depend on the area. Machine
translation is very score-oriented – if it isn't better, the most common
question is, "Why didn't you use a neural net?".

[BertholdCrysmann](../BertholdCrysmann): How do you follow up after a
question like that?

[FrancisBond](../FrancisBond): There's no follow-up.

[DanFlickinger](../DanFlickinger): In quite a few of these applications,
...
[JanBuys](../JanBuys): That's a definite limitation. One solution is to
...
[DanFlickinger](../DanFlickinger): Woodley has built on Yi Zhang's work,
...
[JanBuys](../JanBuys): I'll be talking about that trade-off this afternoon.

[DanFlickinger](../DanFlickinger): There's a place to do that without
abandoning the linguistic structure altogether.

[FrancisBond](../FrancisBond): Whether we can throw away part of the
...
[JanBuys](../JanBuys): We can still leverage the grammar even without full
...
[EmilyBender](../EmilyBender): How do we get robustness? Can we mine the
parse chart for partial parses?

[JanBuys](../JanBuys): There is one avenue, of span-based neural parsing –
...
[EmilyBender](../EmilyBender): I'm thinking about places where the grammar
tells you something – I can't give you a spanning parse, but I can give
you the pieces I found.

[JanBuys](../JanBuys): There must be a way to represent these partial
...
[EmilyBender](../EmilyBender): The way our composition works means they
will have partial MRSs, but there's the stuff you want to see, and all
kinds of weird stuff.

[DanFlickinger](../DanFlickinger): I've always been sceptical about the
...
[EmilyBender](../EmilyBender): Maybe for the ERG. What about Zhong?

[FrancisBond](../FrancisBond): Zhong covers many phenomena! Topicalisation,
dropped subjects...

[DanFlickinger](../DanFlickinger): Gaps, coordination in surprising ways...
analyses that a grammar writer doesn't want but can't see how to exclude
them in principle.

[EmilyBender](../EmilyBender): Could we strip out extracted versions? Find
a subset of the chart in a principled way

[DanFlickinger](../DanFlickinger): Years ago, people tried to do some of
those straightforward ways to explore the chart.

[BerndKiefer](../BerndKiefer): Yes, but we were very restrictive. We looked
for big NP things that we could combine with the verbs floating around.
We didn't get far.

[JohnCarroll](../JohnCarroll): We did a similar thing with RASP, with
...
[BerndKiefer](../BerndKiefer): With these new neural methods, can we do
better than a PCFG?

[JanBuys](../JanBuys): In principle, some of these neural models have shown
...
[BerndKiefer](../BerndKiefer): If you wouldn't dare to put these things in
...
[DanFlickinger](../DanFlickinger): It's tempting to let data-driven systems
...
[DanFlickinger](../DanFlickinger): Efficiency in finding constituents, even
...
[EmilyBender](../EmilyBender): The training data could be a chart and the
best parse.

[JohnCarroll](../JohnCarroll): Often, context is the discriminating factor.
...
[JanBuys](../JanBuys): [TurboParser](/TurboParser) uses dependency parsing
with higher order features – we can deal with that.

[DanFlickinger](../DanFlickinger): Using context?

[JanBuys](../JanBuys): It's not deep learning, just a general parsing
algorithm using dual composition or something. Has been applied with
neural features.

[FrancisBond](../FrancisBond): One place a neural net has been effective,
...
[JanBuys](../JanBuys): Models that work on the character level could be
...
[BerndKiefer](../BerndKiefer): I'm advocating one application where
...
[JanBuys](../JanBuys): In research, people use neural systems for dialogue,
but not in practice, because it's not robust. There are no guarantees
about it doing the right thing.

[BerndKiefer](../BerndKiefer): There is much less complexity than in
...
[BerndKiefer](../BerndKiefer): If I have a vector from another system, I
...
[BerndKiefer](../BerndKiefer): I agree, and there have been fantastic
...
[EmilyBender](../EmilyBender): I was at Amazon, and they have no
...
[JohnCarroll](../JohnCarroll): Is there a gap in the market for a system
...
[EmilyBender](../EmilyBender): We're a long way from that being a killer
app.

[JohnCarroll](../JohnCarroll): At least it's a generic technology.

[BerndKiefer](../BerndKiefer): There's also neural work using AMRs, which
seem to be impoverished MRSs.

[EmilyBender](../EmilyBender): "Impoverished" is not quite fair – they do
some things we don't do, so there are both sides of the Venn diagram.
But we're more consistent.

[JanBuys](../JanBuys): If people don't know enough about these different
