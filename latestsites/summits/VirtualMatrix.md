...
doesn’t detect it as a MIT license. If I go to [PyDelphin](PyDelphin),
...
[PyDelphin](PyDelphin) to support generation
...
automatically when you push commits. For [PyDelphin](PyDelphin), when I
