...
single thing I run into most frequently in [DeepBank](https://blog.inductorsoftware.com/docsproto/concept/DeepBank) tree
...
[WikiWoods](https://blog.inductorsoftware.com/docsproto/concept/WikiWoods) lot of data) is going to be tricky.
