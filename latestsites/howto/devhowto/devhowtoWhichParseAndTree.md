...
As discussed in the [MRS topic](https://blog.inductorsoftware.com/docsproto/howto/devhowto/devhowtoMRS) and the [Well-Formed Trees topic](https://blog.inductorsoftware.com/docsproto/howto/devhowto/devhowtoWellFormedTree), a single phrase like "Look under the table" produces `m` MRS documents, and each of those produces `n` well-formed trees, thus generating `m x n` potential interpretations of a phrase. How do you determine which one is the one the user *meant*?
...
Last update: 2023-01-09 by EricZinda [[edit](https://github.com/ericzinda/Perplexity/edit/main/docs/devhowto/devhowtoWhichParseAndTree.md)]{% endraw %}