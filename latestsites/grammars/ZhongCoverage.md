...
1. **best**: 5
1. **timeout**: 5 (sec.)
1. **max-chart-megabyte**: 256 (mb) for parsing, 2048mb for generation
(fixed)
1. **max-unpack-megabyte**: 256 (mb) for parsing, 2048mb for generation
(fixed)
...
translation later.
1. **fu-berlin**: This testsuite was created as a project of
...
1. **mcg-smallest**: Mandarin Chinese Grammar
1. **mcg-wxl**: The data above and this were constructed based on the
...
sentences).
1. **sinica-test**: The Sinica Treebank include in the NLTK
...
1. **art**: see <http://sweaglesw.org/linguistics/libtsdb/art>
1. **pyDelphin**: see <https://github.com/goodmami/pydelphin>
1. **gTest**: see <https://github.com/goodmami/gtest>
...
1. **Generation Coverage**: This is computed by one-best parsing and
generation.
1. **End-to-end Coverage**: Parsing Coverage \* Generation Coverage
