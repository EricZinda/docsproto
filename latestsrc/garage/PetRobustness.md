...
[Chart\_Mapping](https://blog.inductorsoftware.com/docsproto/tools/Chart_Mapping). In this new setup, the parser tries to
...
page on [Chart\_Mapping](https://blog.inductorsoftware.com/docsproto/tools/Chart_Mapping) for more information.
