...
This page documents Version 1.0 of [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank), released in
...
(PTB). The selection of sentences included in [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) is
...
[DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) is derivative of the PTB.

[DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) annotations are distributed through the
...
[DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) is appropriately acknowledged and its license terms
preserved.

For communication with [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) developers and users, there
...
analysis at all in [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank).

# Corpus Organization

[DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) follows the section division familiar from the PTB,
...
The not manually validated, robust analyses in [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) are
...
The native representation of the HPSG analyses in [DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank)
...
[DeepBank](https://blog.inductorsoftware.com/docsproto/garage/DeepBank) annotations are combined in the files below
