...
We are almost done, but that last message is not great. As always, when we add a new predication to the system, we need to teach the NLG system how to interpret the new predications so that it doesn't say 'thing' in the error:
...
Last update: 2023-01-24 by EricZinda [[edit](https://github.com/ericzinda/Perplexity/edit/main/docs/devvocab/devvocabFileDirectoryNames.md)]{% endraw %}