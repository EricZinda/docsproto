...
|:----------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|                                    **Monday 29 July**                                    |                                                                                                                                                                    |
|                                          9-9:30                                          |                                                           [Opening Tutorial](DelphinTutorial) (Emily,oe)                                                           |
...
|                                       14:00-14:30                                        |      Discussion: [SEM-I history, future, cross-linguistic harmonization](../SaarlandSemi) (Moderator: Emily, Scribe: Woodley; background: [RmrsSemi](https://blog.inductorsoftware.com/docsproto/concept/RmrsSemi))       |
...
|                                       13:50-14:15                                        |                                       [ERG Semantic Documentation](https://blog.inductorsoftware.com/docsproto/concept/ErgSemantics): Progress report & outlook (Emily, oe, Dan)                                       |
...
| [PCFG and dependency conversion+parsing with DeepBank(s)](SaarlandPcfgDependency) (Yi, oe, Angelina) |                                                  Use of \[incr tsdb()\] tools for checking semantic well-formedness on parsed profiles (Dan)                                                   |
...
|      [Phenomenon-specific discussion of improvements to MRSs](https://blog.inductorsoftware.com/docsproto/concept/SaarlandSententialArgument) (Dan)      |                                                               Formalizing (in)formalisms (possibly with updated DTDs for \*MRS)                                                                |
|                                    12:30-13:30 Lunch *(on site)*                                     |                                                                                                                                                                                                |
