...
ICONS is for encoding Information Structure (see [Song and
Bender,
...
output. More information is available at PredicateRfc.
...
SEM-I for serialization and deserialization in order to map
